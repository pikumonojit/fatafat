...
export default async function Home() {
  ...
  return <main className="page">
    ...
    <div className="dashboard">
      ...
      <aside className="rightbar"><div className="quick panel"><div className="quick-title">🔗 QUICK LINKS</div><a href="#today">▣ &nbsp; Today Result</a><a href="#old">◷ &nbsp; Old Result</a><a href="#patti-list">☷ &nbsp; Patti List</a><a href="#chart">▥ &nbsp; Game Chart</a></div><div className="right-notice"><h3>🔔 NOTICE</h3><ul><li>Results are updated when published.</li><li>This website is for informational purposes only.</li><li>No gambling, betting or wagering services are offered.</li><li>Please use information responsibly.</li></ul></div><div className="brand-card"><div>♛</div><b>MATKA KING<br/><span>FATAFAT</span></b><small>FAST • CLEAR • INFORMATION</small></div></aside>
    </div>
